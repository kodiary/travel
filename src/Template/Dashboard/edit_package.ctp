    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="dashboard_graph x_panel">
            ...
            <div class="x_content">
                ...
                <div class="col-md-3"></div><div class="col-md-9"><a href="javascript:void(0)" class="btn btn-default btn-lg add_slider">ADD MORE</a></div>
                <div class="clearfix"></div>                                
                <hr />
                 <div class="form-group">
    ...
    function fileUpload(ID) {
        ...
        var upload = new AjaxUpload("#" + ID, {
            ...
            onComplete: function (file, response) {
                if (response != 'error') {
                    $('.'+random+' #image_'+random).val(response);
                    $('.'+random+' .imagebody').html('<img src="<?php echo $this->request->webroot;?>img/package/resized/'+response+'" style="width:300px;height:300px;" />');
                    $('.'+random+' .cropbody').show();
                    $('.'+random+' .cropbody').html('<img id="cropbox1" src="<?php echo $this->request->webroot;?>img/package/resized/'+response+'" style="width:785px;" class="tocrop" />');
...
$(document).ready(function(){
    $('.add_slider').click(function(){
       ...
       $.ajax({
        url:'<?php echo $this->request->webroot;?>dashboard/loadPackSlider',
        data:'rand='+rand,
        type:'post',                
        success:function(res){
            $('.sliders').append(res);
             fileUpload('upload'+rand);            
