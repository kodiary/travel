        ...
        <div class="dashboard_graph x_panel">
            ...
            <div class="x_content">
                ...
                foreach($model as $m)
                {
                    ...
                    ?>
                    <tr><td><?php echo $i;?></td><td><?php echo $m->title;?></td><td><a href="<?php echo $this->request->webroot;?>dashboard/editTour/<?php echo $m->id;?>" class="btn btn-primary">Edit</a> <a href="<?php echo $this->request->webroot;?>dashboard/deleteTour/<?php echo $m->id;?>" class="btn btn-danger">Delete</a></td></tr>
